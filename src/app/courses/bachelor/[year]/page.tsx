...
import { ArrowLeft, BookOpen, Clock, Award, Code } from 'lucide-react'
import Link from 'next/link'
import { coursesData } from '@/data/courses'
import { Breadcrumb } from '@/components/breadcrumb'

export default function BachelorYearPage({ params }: { params: Promise<{ year: string }> }) {
  const { language } = useLanguage()
  const { year } = use(params)
  const yearData = coursesData.bachelor[year as keyof typeof coursesData.bachelor]
  ...
  { label: 'Bachelor', labelLao: 'ປະລິນຍາຕີ', href: '/courses' },
